...
export { CleanupError, Result } from "./result.ts";
export type {
  Cause,
  CleanupFailure,
  DefectCause,
...
export type Kyoot<A, S extends Row = {}, Ops = unknown> = KyootType<A, S, Ops>;
export const Kyoot = { succeed, gen, defer, runSync, runPromise };
